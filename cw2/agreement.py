...
# Availabel operations on trees:  tr.label(), tr[i],  len(tr)
...
#    lx.add('ROBBY','P')
#    lx.add('red','A')
#    tr0 = all_valid_parses(lx, ['John','has','a','dog','?'])[0]
#    tr = restore_words(tr0,['Who','likes','John','?'])
#    #tr0 = all_valid_parses(lx, ['Which','red','dogs','does','John','like','?'])[0]
#    #tr = restore_words(tr0,['Which','red','dogs','does','John','like','?'])
#    tr.draw()
    ##print(len(tr0))
# End of PART C.'''
